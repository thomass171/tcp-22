...
public class SimpleHeadlessPlatform extends DefaultPlatform {
    ...
    static class DummyTransform implements NativeTransform {
    ...
    public class DummyMaterial implements NativeMaterial {
    ...
    class DummyGeometry implements NativeGeometry {
        ...
        // for better debugging have it readable
        List<Vector3> readableVertices = new ArrayList<>();
        int[] indices;

        DummyGeometry(Vector3Array vertices, int[] indices, Vector2Array uvs, Vector3Array normals) {
            this.vertices = vertices;
            for (int i = 0; i < vertices.size(); i++) {
                this.readableVertices.add(vertices.getElement(i));
            }
