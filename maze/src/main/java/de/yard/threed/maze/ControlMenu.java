...
public class ControlMenu implements ControlMenuBuilder {
    ...
    public GuiGrid buildControlMenu(Camera camera) {
        ...
        controlmenu.addButton(0, 0, 1, Icon.ICON_LEFTARROW, () -> {
            InputToRequestSystem.sendRequestWithId(new Request(MazeRequestRegistry.TRIGGER_REQUEST_LEFT));
        });
        ...
        controlmenu.addButton(2, 0, 1, Icon.ICON_DOWNARROW, () -> {
            InputToRequestSystem.sendRequestWithId(new Request(MazeRequestRegistry.TRIGGER_REQUEST_BACK));
        });
        ...
        controlmenu.addButton(4, 0, 1, Icon.ICON_RIGHTARROW, () -> {
            InputToRequestSystem.sendRequestWithId(new Request(MazeRequestRegistry.TRIGGER_REQUEST_RIGHT));
        });

        //mid
        controlmenu.addButton(1, 1, 1, Icon.ICON_TURNLEFT, () -> {
            InputToRequestSystem.sendRequestWithId(new Request(MazeRequestRegistry.TRIGGER_REQUEST_TURNLEFT));
        });
        ...
        controlmenu.addButton(3, 1, 1, Icon.ICON_TURNRIGHT, () -> {
            InputToRequestSystem.sendRequestWithId(new Request(MazeRequestRegistry.TRIGGER_REQUEST_TURNRIGHT));
        });

        //top
        controlmenu.addButton(2, 2, 1, Icon.ICON_UPARROW, () -> {
            InputToRequestSystem.sendRequestWithId(new Request(MazeRequestRegistry.TRIGGER_REQUEST_FORWARD));
        });
