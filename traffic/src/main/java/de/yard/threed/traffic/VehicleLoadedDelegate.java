 ...
 *
 * 9.11.21: Decoupled and moved from fg to traffic
 * Created on 02.03.18.
 */
@FunctionalInterface
public interface VehicleLoadedDelegate {

    void vehicleLoaded(SceneNode raised,/* SceneNode basemodel,*/ VehicleLoaderResult loaderResult/*9.11.21List<SGAnimation> animationList, SGPropertyNode propertyNode*/, SceneNode lowresNode);
