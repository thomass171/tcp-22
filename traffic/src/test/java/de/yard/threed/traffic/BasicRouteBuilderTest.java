 ...
 */
@Slf4j
public class BasicRouteBuilderTest {
    ...
    public void testEDKB29_EDDK06() {
        ...
        BasicRouteBuilder basicRouteBuilder = new BasicRouteBuilder(new SimpleEllipsoidCalculations(SimpleEllipsoidCalculations.eQuatorialEarthRadius));
        GeoRoute geoRoute = basicRouteBuilder.buildAirportToAirportRoute(edkb29From, edkb29To, eddk06From, eddk06To);
    ...
    public void testEDKB11_EDDK06() {
        ...
        BasicRouteBuilder basicRouteBuilder = new BasicRouteBuilder(new SimpleEllipsoidCalculations(SimpleEllipsoidCalculations.eQuatorialEarthRadius));
        GeoRoute geoRoute = basicRouteBuilder.buildAirportToAirportRoute(edkb11From, edkb11To, eddk06From, eddk06To);
    ...
    public void testEDKB29_EDDK24() {
        ...
        BasicRouteBuilder basicRouteBuilder = new BasicRouteBuilder(new SimpleEllipsoidCalculations(SimpleEllipsoidCalculations.eQuatorialEarthRadius));
        GeoRoute geoRoute = basicRouteBuilder.buildAirportToAirportRoute(edkb29From, edkb29To, eddk24From, eddk24To);
    ...
    public void testEDKB11_EDDK24() {
        ...
        BasicRouteBuilder basicRouteBuilder = new BasicRouteBuilder(new SimpleEllipsoidCalculations(SimpleEllipsoidCalculations.eQuatorialEarthRadius));
        GeoRoute geoRoute = basicRouteBuilder.buildAirportToAirportRoute(edkb11From, edkb11To, eddk24From, eddk24To);
