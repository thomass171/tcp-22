...
public class GridTeleporterTest {
    ...
    public void testMoveDestinationMarker() {
        ...
        TestUtils.assertVector3(new Vector3(4, GridTeleporter.VISIBLE_GROUNDMARKER_Y, -6.375), directionMarker.getTransform().getPosition());
        TestUtils.assertVector3(new Vector3(4, GridTeleporter.HIDDEN_GROUNDMARKER_Y, -6 - 0.25 - 0.125), localMarker.getTransform().getPosition());
        TestUtils.assertQuaternion( Quaternion.buildRotationY(new Degree(0)), directionMarker.getTransform().getRotation(),"");
        ...
        TestUtils.assertVector3(new Vector3(4, GridTeleporter.VISIBLE_GROUNDMARKER_Y, -5.625), directionMarker.getTransform().getPosition());
        TestUtils.assertVector3(new Vector3(4, GridTeleporter.HIDDEN_GROUNDMARKER_Y, -6 + 0.25 + 0.125), localMarker.getTransform().getPosition());
        TestUtils.assertQuaternion( Quaternion.buildRotationY(new Degree(180)), directionMarker.getTransform().getRotation(),"");
        ...
        TestUtils.assertVector3(new Vector3(4.375, GridTeleporter.VISIBLE_GROUNDMARKER_Y, 6), directionMarker.getTransform().getPosition());
        TestUtils.assertVector3(new Vector3(4 + 0.25 + 0.125, GridTeleporter.HIDDEN_GROUNDMARKER_Y, 6), localMarker.getTransform().getPosition());
        TestUtils.assertQuaternion( Quaternion.buildRotationY(new Degree(-90)), directionMarker.getTransform().getRotation(),"");
        ...
        TestUtils.assertVector3(new Vector3(3.625, GridTeleporter.VISIBLE_GROUNDMARKER_Y, 6), directionMarker.getTransform().getPosition());
        TestUtils.assertVector3(new Vector3(4 - 0.25 - 0.125, GridTeleporter.HIDDEN_GROUNDMARKER_Y, 6), localMarker.getTransform().getPosition());
        TestUtils.assertQuaternion( Quaternion.buildRotationY(new Degree(90)), directionMarker.getTransform().getRotation(),"");
    ...
    public void testMoveDestinationMarkerSize15() {
        ...
        TestUtils.assertVector3(new Vector3(0, GridTeleporter.VISIBLE_GROUNDMARKER_Y, -1.5), directionMarker.getTransform().getPosition());

        intersectionInNegativeCenterArea = new Vector2(0.2, -3);
        gridTeleporter.moveDestinationMarker(intersectionInNegativeCenterArea, localMarker, directionMarker, 1.5);
        TestUtils.assertVector3(new Vector3(0, GridTeleporter.VISIBLE_GROUNDMARKER_Y, -3), directionMarker.getTransform().getPosition());
        ...
        TestUtils.assertVector3(new Vector3(1.5, GridTeleporter.VISIBLE_GROUNDMARKER_Y, -1.5 - (1.5 / 2) + 1.5 / 8), directionMarker.getTransform().getPosition());

    }

    @Test
    public void testOffset() {
        Assertions.assertEquals( 3 * 1.5 / 8, GridTeleporter.getCenterOffset(1.5));
    }
}
