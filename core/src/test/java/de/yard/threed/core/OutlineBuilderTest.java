...
public class OutlineBuilderTest {
    ...
    public void testSimpleOutline() {
        ...
        TestUtil.assertEquals("size", vlist.size(),outline.size());
        TestUtil.assertVector2("", new Vector2(20-offset45,30-offset45), outline.get(0));
        TestUtil.assertVector2("", new Vector2(26.14805029709527,22.228361402466142), outline.get(1));
        TestUtil.assertVector2("", new Vector2(27.771638597533858,33.85194970290473), outline.get(3));
        TestUtil.assertVector2("", new Vector2(45-offset45,35-+offset45), outline.get(7));

        //links
        outline =  OutlineBuilder.getOutline(vlist, -3);
        TestUtil.assertEquals("size", vlist.size(),outline.size());
        TestUtil.assertVector2("", new Vector2(20+offset45,30+offset45), outline.get(0));
        TestUtil.assertVector2("", new Vector2(35,45+offset), outline.get(5));
        TestUtil.assertVector2("", new Vector2(45+offset45,35+offset45), outline.get(7));
